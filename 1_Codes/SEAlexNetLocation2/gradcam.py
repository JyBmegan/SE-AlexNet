...
if __name__ == '__main__':
    ...
    exp_name = "Location-2-ObjectBased-32-E"                                                              # check point 8
    ...
    #for i in range(300):
        ...
        # load model weights
        weights_path = "/home/zhang/share/home/scz6112/AffectNet/ALLResultsCollection/ClassifiedWithCondition/SELocate-2/ObjectBased/squeeze-32/AlexNet.pth"  # check point 5: SE Location/ Face or Object/ squeeze
        ...
        # file.close()
        # Layer cam3
        layer_cam = GradCam(pretrained_model, target_layer='9')                                                # check point 6: for different SE location
        # Generate cam mask
