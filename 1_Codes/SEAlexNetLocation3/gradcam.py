...
if __name__ == '__main__':
    ...
    exp_name = "Location-3-FaceBased-32-Full"                                         # check point 8
    ...
    for i, filename in enumerate(os.listdir('/home/zhang/share/home/scz6112/AffectNet/ALLResultsCollection/ClassifiedWithCondition/input_images/Full'), 1):  # check point 4: Full or M or N or E
    #for i in range(300):
        img_path = '/home/zhang/share/home/scz6112/AffectNet/ALLResultsCollection/ClassifiedWithCondition/input_images/Full/' + str(filename)  # check point 7: Full or M or N or E
        ...
        # create model
        model = AlexNetWithSE(num_classes=11)


        device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
        print (AlexNetWithSE().to(device))
        # load model weights
        weights_path = "/home/zhang/share/home/scz6112/AffectNet/ALLResultsCollection/ClassifiedWithCondition/SELocate-3-best/FaceBased/squeeze-32/AlexNet.pth"  # check point 5: SE Location/ Face or Object/ squeeze
        ...
        # file.close()
        # Layer cam3
        layer_cam = GradCam(pretrained_model, target_layer='10')                                                # check point 6: for different SE location
        # Generate cam mask
